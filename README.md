...
- Automatic extraction/auto-fill for client name, timeline, drawing count, complexity, revision risk, and optional services from uploaded requirement content, with automatic quote generation after upload.
